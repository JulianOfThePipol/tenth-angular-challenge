import { CategoryState } from '../categories/featureStore/categories.reducers';
import {
  CartResponse,
  Product,
  ProductsResponse,
...
export const categoryStateMock: CategoryState = { categories: [categoryMock] };
...
export const getCartResponseMock: CartResponse = {
  data: {
    id: 311,
    user_id: 6,
    number: 282,
...
export const likeResponseMock: LikesResponse = {
  data: [
    {
      id: 101,
      user_id: 6,
